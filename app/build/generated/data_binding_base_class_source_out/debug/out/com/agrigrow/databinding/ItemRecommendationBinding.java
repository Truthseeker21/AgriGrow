...
public final class ItemRecommendationBinding implements ViewBinding {
  ...
  private ItemRecommendationBinding(@NonNull CardView rootView,
      @NonNull TextView textViewRecommendation) {
    this.rootView = rootView;
    this.textViewRecommendation = textViewRecommendation;
  }
  ...
  public static ItemRecommendationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.textViewRecommendation;
      TextView textViewRecommendation = ViewBindings.findChildViewById(rootView, id);
      if (textViewRecommendation == null) {
        break missingId;
      }

      return new ItemRecommendationBinding((CardView) rootView, textViewRecommendation);
    }
